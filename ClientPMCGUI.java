...
public class ClientPMCGUI extends JComponent
{	// open CLASS
...
//--------------------------------------
	...
	public ClientPMCGUI(final ClientPMC mClient)
	{	// open CONSTRUCTOR
		...
		// Title Window
		window.setTitle("Private Mini-Chat Client");
		...
		{	// open ANON ACTIONLISTENER
			...
			{	// open ACTIONLISTENER METHOD
				...
				// call to MessagerServer to send message
				mClient.sendMessage(ae.getActionCommand() );
				enterField.setText("");
